  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "fixed inset-x-0 bottom-0 z-50 grid w-full max-h-[90vh] overflow-y-auto gap-4 p-6 text-stone-900 rounded-t-2xl rounded-b-none shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
